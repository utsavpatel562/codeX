...
<html lang="en">
  ...
  <body class="antialiased">
    <div class="wrapper">
      <header class="navbar navbar-expand-md navbar-dark navbar- d-print-none" style="background:#000; height:50px;">
        <div class="container-xl">
          ...
          <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="#">
              <img src="img/mylogo.png" style="height:36px;" class="navbar-brand-image">
            </a>
          </h1>
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      ...
                      <div class="dropdown-menu-column">
                        ...
                        <div class="dropend">
                          <a class="dropdown-item" href="user_profilel.php" data-bs-toggle="dropdown" role="button" aria-expanded="false" >
                           Account Details
                          </a>
                          <div class="dropdown-menu">
                          </div>
